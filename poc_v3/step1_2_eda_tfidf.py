"""
ST545 POC v3 — Step 1 & 2: EDA + TF-IDF Baseline
===================================================
Changes from v2:
 - Publisher normalization (benzinga → Benzinga)
 - Saves output to poc/result/
"""
...
plt.title('Top 15 News Publishers (All Tickers, Normalized)')
...
print(f"\n{'='*50}")
print(f"  POC v3 Step 1 & 2 Results (TimeSeriesSplit)")
print(f"{'='*50}")
...
print(f"  Publishers: {df['Publisher'].nunique()} (after normalization)")

with open('poc/result/eda_tfidf_results.txt', 'w') as f:
    f.write("ST545 POC v3 Step 1 & 2 Results\n")
    f.write("================================\n")
    ...
    f.write(f"Publishers: {df['Publisher'].nunique()} (benzinga normalized to Benzinga)\n")
...
print("\n[+] POC v3 Step 1 & 2 complete. Results in poc/result/")
