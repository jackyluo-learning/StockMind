"""
ST545 POC v3 — Step 0: FinBERT Sentiment Cache
================================================
Run this ONCE to compute FinBERT sentiment for all articles.
Saves to dataset/sentiment_cache.csv, shared by step3/4/5.

Also normalizes publisher names (benzinga → Benzinga).
"""
...
PUBLISHER_NORM = {
    'benzinga': 'Benzinga',   # Alpaca uses lowercase, Finnhub uses capitalized
}
