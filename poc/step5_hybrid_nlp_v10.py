"""
ST545 POC v10 (Baseline Hybrid) — Step 5: v10 Synergy Analysis
========================================================================
1. Global PCA: Reduce 768-dim FinBERT to 8-dim.
2. No Media Weighting, No DQS Gating (Simple Daily Mean).
3. Lasso Top 10 Keywords.
4. Synergy Breakdown: Market vs Sentiment vs Keywords vs Hybrid.
"""
...
print("--- v10: Loading Global Cache & Performing Global 8-dim PCA ---")
...
for ticker in TICKERS:
    ...
    X_sent = df_t[['Sentiment_Score'] + pca_cols].values
...
with open(f'{RESULT_DIR}/hybrid_report_v10.txt', 'w') as f:
    f.write("ST545 POC v10 Synergy Report - Lasso Top 10 + PCA 8 (Simple Mean)\n" + "="*80 + "\n")
...
print(f"\n[+] v10 complete. Results saved in {RESULT_DIR}")
